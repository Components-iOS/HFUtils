...
#import <Foundation/Foundation.h>
    ...
    #define HFMAS_VIEW UIView
    #define HFMAS_VIEW_CONTROLLER UIViewController
    #define HFMASEdgeInsets UIEdgeInsets
    ...
    #define HFMAS_VIEW NSView
    #define HFMASEdgeInsets NSEdgeInsets
...
static inline id _MASBoxValue(const char *type, ...) {
    ...
    if (strcmp(type, @encode(id)) == 0) {
        ...
        obj = [NSValue value:&actual withObjCType:type];
    } else if (strcmp(type, @encode(HFMASEdgeInsets)) == 0) {
        HFMASEdgeInsets actual = (HFMASEdgeInsets)va_arg(v, HFMASEdgeInsets);
        obj = [NSValue value:&actual withObjCType:type];
