 ...
 */
+ (nullable instancetype)hf_modelWithJSON:(id)json;
...
/**
 ...
 property, this method will try to convert the value based on these rules:
     ...
     `NSString` -> SEL, Class.
 */
+ (nullable instancetype)hf_modelWithDictionary:(NSDictionary *)dictionary;
 ...
 */
- (nullable id)hf_modelToJSONObject;
 ...
 */
- (nullable NSData *)hf_modelToJSONData;
...
/**
 ...
 inner object to json string.
 */
- (nullable NSString *)hf_modelToJSONString;
 ...
 */
+ (nullable NSArray *)hf_modelArrayWithClass:(Class)cls json:(id)json;
 ...
 */
@interface NSDictionary (HFModel)
 ...
 */
+ (nullable NSDictionary *)hf_modelDictionaryWithClass:(Class)cls json:(id)json;
...
/**
 ...
 There's no need to add '<HFModel>' to your class header.
 */
@protocol HFModel <NSObject>
@optional
