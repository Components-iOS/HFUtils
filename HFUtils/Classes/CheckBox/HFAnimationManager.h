...
/** Animation object used by HFCheckBox to generate animations.
 */
@interface HFAnimationManager : NSObject

/** The duration of the animation created by the HFAnimationManager object.
 */
@property (nonatomic) CGFloat animationDuration;

/** Designated initializer.
 * @param animationDuration The duration of the animations created with the HFAnimationManager object.
 * @return Returns the a fully initialized HFAnimationManager object.
 */
