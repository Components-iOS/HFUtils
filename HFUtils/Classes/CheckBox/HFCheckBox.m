...
/** The HFAnimationManager object used to generate animations.
 */
@property (strong, nonatomic) HFAnimationManager *animationManager;

/** The HFPathManager object used to generate paths.
 */
@property (strong, nonatomic) HFPathManager *pathManager;
...
- (void)commonInit {
    ...
    _onAnimationType = HFAnimationTypeStroke;
    _offAnimationType = HFAnimationTypeStroke;
...
- (void)initPathManager {
    _pathManager = [HFPathManager new];
...
- (void)initAnimationManager {
    _animationManager = [[HFAnimationManager alloc] initWithAnimationDuration:_animationDuration];
}
...
- (void)setBoxType:(HFBoxType)boxType {
    _boxType = boxType;
...
- (void)setOffAnimationType:(HFAnimationType)offAnimationType {
...
- (void)addOnAnimation {
    ...
    switch (self.onAnimationType) {
        ...
        case HFAnimationTypeBounce: {
            CGFloat amplitude = (self.boxType == HFBoxTypeSquare) ? 0.20 : 0.35;
