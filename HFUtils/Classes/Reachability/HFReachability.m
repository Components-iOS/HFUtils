...
NSString *const kHFReachabilityChangedNotification = @"kHFReachabilityChangedNotification";

@interface HFReachability ()
...
static NSString *hf_reachabilityFlags(SCNetworkReachabilityFlags flags)
{
...
{
    return [HFReachability reachabilityWithHostname:hostname];
}
...
- (BOOL)startNotifier
{
    ...
    if (SCNetworkReachabilitySetCallback(self.reachabilityRef, HFTMReachabilityCallback, &context))
    {
...
{
    return hf_reachabilityFlags([self reachabilityFlags]);
}
...
- (void)reachabilityChanged:(SCNetworkReachabilityFlags)flags
{
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        [[NSNotificationCenter defaultCenter] postNotificationName:kHFReachabilityChangedNotification
                                                            object:self];
    });
}
