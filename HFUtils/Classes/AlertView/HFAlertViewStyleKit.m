...
// ------------------------------------
@implementation HFAlertViewStyleKit
...
+ (UIImage*)imageOfCheckmark
{
    ...
    [HFAlertViewStyleKit drawCheckmark];
...
+ (UIImage*)imageOfNotice
{
    ...
    UIGraphicsBeginImageContextWithOptions(CGSizeMake(80, 80), NO, 0);
    [HFAlertViewStyleKit drawNotice];
...
+ (UIImage*)imageOfWarning
{
    ...
    UIGraphicsBeginImageContextWithOptions(CGSizeMake(80, 80), NO, 0);
    [HFAlertViewStyleKit drawWarning];
...
+ (UIImage*)imageOfQuestion
{
    ...
    UIGraphicsBeginImageContextWithOptions(CGSizeMake(80, 80), NO, 0);
    [HFAlertViewStyleKit drawQuestion];
